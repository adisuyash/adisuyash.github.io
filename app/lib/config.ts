export const metaData = {
  ...
  description:
    "Building developer communities, educating on Web3, and simplifying blockchain through content.",
};

export const socialLinks = {
  twitter: "https://x.com/adisuyash",
  github: "https://github.com/adisuyash",
